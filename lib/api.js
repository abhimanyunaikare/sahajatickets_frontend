...
export const LANG = {
  en: {
    ...
    ticketReady: 'Your ticket is confirmed!',
    scanQR: 'Show this QR at entry',
    donate: 'Add a Dana (Donation)',
    donateSubtitle: 'Your ticket is confirmed. Offer any amount — fully optional.',
    skip: 'Skip — no offering this time',
    dedicate: 'Dedicate this offering',
    anonymous: 'Offer anonymously',
    free: 'FREE',
  },
  hi: {
